      ...
      <div className="mx-auto max-w-[1400px]">
        <div className="grid gap-14 md:grid-cols-[300px_1fr] md:gap-16 lg:grid-cols-[360px_1fr]">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-5 max-w-[32ch] text-sm leading-relaxed text-[#4467a9]/50">
            ...
            <Link
              href="/productos"
              className="mt-8 inline-block self-start rounded-full border-2 border-[#4467a9] bg-transparent px-8 py-3 font-display text-xs font-black uppercase tracking-widest text-[#4467a9] transition-colors hover:bg-[#4467a9] hover:text-[#f1ead0]"
            >
              VER TODO →
            </Link>
          </div>
          ...
          <div className="flex min-w-0 flex-col gap-7">
            ...
            <div ref={containerRef} className="relative min-w-0 overflow-hidden">
              ...
              >
                {products.map((product, i) => (
                  ...
                  >
                    ...
                    >
                      <span
                        className="pointer-events-none absolute bottom-2 right-4 select-none font-display font-black italic uppercase text-[#4467a9]/10"
                    ...
                    <div className="p-5">
                      ...
                      <p className="mt-2 text-xs leading-relaxed text-[#4467a9]/50 line-clamp-3">
                        <strong className="font-black text-[#4467a9]/60">descripción:</strong>{" "}
                        {product.description}
                      </p>
                      <p
                        className="mt-3 font-display uppercase text-[#4467a9]/50"
              ...
              <div className="mt-6 flex items-center gap-4 border-t border-[#4467a9]/10 pt-5">
                <button
                  onClick={prev}
                  disabled={currentIdx === 0}
                  aria-label="Anterior"
                  className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-[#4467a9] text-[#4467a9] transition-colors hover:bg-[#4467a9] hover:text-[#f1ead0] disabled:cursor-not-allowed disabled:opacity-20"
                >
