    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-[#f1ead0] px-6 pb-10 pt-12 md:px-12 md:pt-16">
        <div className="mx-auto max-w-[1400px]">
          <p className="mb-2 font-sans text-xs font-bold uppercase tracking-[0.2em] text-[#08234e]/40">
            Catálogo
          </p>
          <h1
          ...
          <p className="mt-3 max-w-xl font-sans text-sm leading-relaxed text-[#08234e]/50">
      ...
      <div className="sticky top-[72px] z-30 border-b border-[#08234e]/8 bg-white/95 backdrop-blur-sm">
          ...
          <div className="flex gap-1 overflow-x-auto py-3 scrollbar-hide">
            {tabs.map((tab) => (
              <button
                ...
                className={`shrink-0 rounded-full px-4 py-1.5 font-sans text-sm font-semibold whitespace-nowrap transition-colors ${
                  activecat === tab.id
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <button
              ...
              className="mt-4 font-sans text-sm font-semibold text-[#08234e] underline underline-offset-2"
            >
          ...
          <>
            <p className="mb-6 font-sans text-sm text-[#08234e]/40">
    ...
    <Suspense
      fallback={
        <div className="min-h-screen bg-white">
          <div className="bg-[#f1ead0] px-6 pb-10 pt-12 md:px-12 md:pt-16">
            <div className="mx-auto max-w-[1400px]">
              <div className="h-4 w-24 rounded bg-[#08234e]/10 mb-3" />
              <div className="h-12 w-64 rounded bg-[#08234e]/10" />
            </div>
          </div>
          <div className="mx-auto max-w-[1400px] px-6 py-10 md:px-12">
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
